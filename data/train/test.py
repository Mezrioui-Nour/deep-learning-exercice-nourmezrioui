...
def test_output_exist():
    filepath = r'C:\Users\ITO\Desktop\EXERCICE NOUR\basic-deep-learning-nourmezrioui-main\data\validation\output.tsv'
...
# Appliquer la normalisation aux deux fichiers (probleme de fin de ligne)
    normalize_end_of_line(r'C:\Users\ITO\Desktop\EXERCICE NOUR\basic-deep-learning-nourmezrioui-main\data\validation\output.tsv')
    normalize_end_of_line(r'C:\Users\ITO\Desktop\EXERCICE NOUR\basic-deep-learning-nourmezrioui-main\data\validation\output.tsv')
    
    filename_out = pathlib.Path(r'C:\Users\ITO\Desktop\EXERCICE NOUR\basic-deep-learning-nourmezrioui-main\data\validation\output.tsv')
    filename_ref = pathlib.Path(r'C:\Users\ITO\Desktop\EXERCICE NOUR\basic-deep-learning-nourmezrioui-main\data\validation\output.tsv')
